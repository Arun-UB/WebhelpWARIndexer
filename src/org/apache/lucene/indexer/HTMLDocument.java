...
import org.apache.lucene.indexer.html.HTMLParser;
...
public class HTMLDocument {
  ...
  public static Document Document(File f)
    ...
    doc.add(new Field("summary", ext.getSectionSummary(f), Field.Store.YES, Field.Index.NO));

    // Add the title as a field that it can be searched and that is stored.
    doc.add(new Field("title", ext.getSectionTitle(f), Field.Store.YES, Field.Index.ANALYZED));
